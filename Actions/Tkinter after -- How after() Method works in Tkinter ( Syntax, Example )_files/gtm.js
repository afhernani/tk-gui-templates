...
t.value&&(u=t.value);if(u){var v=u.match(oe);if(v){var x=v[0],y;if(m.location){var w=ie(m.location,"host",!0);y=0<=x.toLowerCase().indexOf(w)}else y=!1;y||p.push({element:t,xa:x})}}}var z=De(p),A=[];if(z){var C=z.element,F={xa:z.xa,tagName:C.tagName,type:1};F.querySelector=Be(C);F.isVisible=!Xd(C);A.push(F)}var D={elements:A,status:10<p.length?"3":n.status};te["true.true"]={timestamp:g(),result:D};return D},Fe=function(a){return a.tagName+":"+a.isVisible+":"+a.xa.length+":"+pe.test(a.xa)};var $e={},af=null,bf=Math.random();$e.M="GTM-PP63D5";$e.Rc="6u0";$e.Ki="";$e.wg="ChEI8PL6hgYQt/6Rz+X/zeH2ARIjABdbn+tgMF9p2Cxs1lipA8MgAScT60HpIfpQ5gplZEcJxYIaAjdh";var cf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},df={__paused:!0,__tg:!0},ef;for(ef in cf)cf.hasOwnProperty(ef)&&(df[ef]=!0);var ff="www.googletagmanager.com/gtm.js";
var gf=ff,hf=Ma(""),jf=null,kf=null,lf="https://www.googletagmanager.com/a?id="+$e.M+"&cv=52",mf={},nf={},of=function(){var a=af.sequence||1;af.sequence=a+1;return a};$e.vg="";var pf={},qf=new Fa,rf={},sf={},vf={name:"dataLayer",set:function(a,b){G(Wa(a,b),rf);tf()},get:function(a){return uf(a,2)},reset:function(){qf=new Fa;rf={};tf()}},uf=function(a,b){return 2!=b?qf.get(a):wf(a)},wf=function(a){var b,c=a.split(".");b=b||[];for(var d=rf,e=0;e<c.length;e++){if(null===d)return!1;if(void 0===d)break;d=d[c[e]];if(-1!==Aa(b,d))return}return d},xf=function(a,b){sf.hasOwnProperty(a)||(qf.set(a,b),G(Wa(a,b),rf),tf())},tf=function(a){Ja(sf,function(b,c){qf.set(b,c);G(Wa(b,
...
Z.g.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=cn(c,"gtm.click");Qo(d)}}(function(b){Z.__cl=b;Z.__cl.h="cl";Z.__cl.m=!0;Z.__cl.priorityOverride=0})(function(b){if(!Vo("cl")){var c=R("document");Gb(c,"click",a,!0);Wo("cl")}E(b.vtp_gtmOnSuccess)})}();Z.g.k=["google"],function(){(function(a){Z.__k=a;Z.__k.h="k";Z.__k.m=!0;Z.__k.priorityOverride=0})(function(a){return So(a.vtp_name,Po("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
p.vtp_trackType){D("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var fa=function(pa){return Po("transaction"+pa,1)},Y=fa("Id");D("ecommerce:addTransaction",{id:Y,affiliation:fa("Affiliation"),revenue:fa("Total"),shipping:fa("Shipping"),tax:fa("Tax")});for(var oa=fa("Products")||[],Ba=0;Ba<oa.length;Ba++){var Ea=oa[Ba];D("ecommerce:addItem",{id:Y,sku:Ea.sku,name:Ea.name,category:Ea.category,price:Ea.price,
quantity:Ea.quantity})}D("ecommerce:send");}else if("TRACK_TIMING"==p.vtp_trackType){}else if("DECORATE_LINK"==
