# WINDOWS TO COPY, MOVE AND RENAME FILES.

![ventana principal](windialog.main.png)

![ventana copiar archivo](windowcopyto.png)

![ventana mover archivo](windowmoveto.png)

![ventana rename archivo](windowrename.png)

En windialog.py incluye la clase ToolFile para actuaciones de copiar, mover y renovar archivos.

De forma independiente se encuentra en el fichero con su propio nombre.

[toolfile.py](toolfile.py)

CODE:

[windialog.py](windialog.py)
