...
Slider]{.breadcrumb_last aria-current="page"}
:::

Tkinter Slider {#tkinter-slider .entry-title}
==============

::: {.entry-content}
**Summary**: in this tutorial, you'll learn how to create a slider using
the Tkinter Scale widget.

Introduction to Tkinter slider widget
-------------------------------------

A slider allows you to enter a value by moving an indicator. A slider
can be vertical or horizontal:

::: {.wp-block-image}
![](https://www.pythontutorial.net/wp-content/uploads/2020/12/Tkinter-Scale.png){.wp-image-1391
width="302" height="232" sizes="(max-width: 302px) 100vw, 302px"
srcset="https://www.pythontutorial.net/wp-content/uploads/2020/12/Tkinter-Scale.png 302w, https://www.pythontutorial.net/wp-content/uploads/2020/12/Tkinter-Scale-300x230.png 300w"}
:::
...
In this syntax, the `container` specifies the parent component of the
slider.

The `from_` and `to` options specify the minimum and maximum values of
the slider. Since `from` is a keyword in Python, Tkinter uses `from_`
instead.

By default, a slider is horizontal. To specify how the slider is
arranged, you use the `orient` option which can be horizontal or
...
To get the current value of the slider, you can assign a `DoubleVar` to
the `variable` of the slider like this:
...
To run a function whenever the value of the slider changes, you can
assign it to the `command` option as follows:
...
Notice that calling a function when the value of the slider changes can
cause performance problems.

### Disabling the slider

To disable the slider, you set its state to `'disabled'`. To re-enable
it, you set its state to `'normal'`.
...
The following program illustrates how to use a Tkinter slider widget.
The label will update the current value of the slider when you change
the slider's value.
...
::: {.wp-block-image}
![](https://www.pythontutorial.net/wp-content/uploads/2020/12/Tkinter-Slider.png){.wp-image-1388
width="302" height="232" sizes="(max-width: 302px) 100vw, 302px"
srcset="https://www.pythontutorial.net/wp-content/uploads/2020/12/Tkinter-Slider.png 302w, https://www.pythontutorial.net/wp-content/uploads/2020/12/Tkinter-Slider-300x230.png 300w"}
:::
...
-   Use the `scale.get()` or the `variable` option to get the current
    value of the slider.
-   Use the `command` option to assign a function that will execute when
...
::: {.page-previous}
[Previous Tkinter
PanedWindow](https://www.pythontutorial.net/tkinter/tkinter-panedwindow/ "Tkinter PanedWindow"){.prev-page-anchor}
:::

::: {.page-next}
[Next Tkinter
Spinbox](https://www.pythontutorial.net/tkinter/tkinter-spinbox/ "Tkinter Spinbox"){.next-page-anchor}
:::
:::
:::
...
::: {#searchwp_live_search_results_60614940679b1 .searchwp-live-search-results aria-expanded="false" role="listbox" tabindex="0" style="left: 970px; top: 153px; width: 300px;"}
:::
