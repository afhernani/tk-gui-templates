...
[Tkinter](https://www.pythontutorial.net/tkinter/) » [Tkinter Radio
Button]{.breadcrumb_last aria-current="page"}
:::

Tkinter Radio Button {#tkinter-radio-button .entry-title}
====================

::: {.entry-content}
**Summary**: in this tutorial, you'll learn how to use the Tkinter radio
button widget to allow users to select between one of a number of
mutually exclusive choices.

Introduction to Tkinter radio buttons
-------------------------------------

Radio buttons allow you to select between one of a number of mutually
exclusive choices.

Typically, you use radio buttons together in a set. They're a good
option if you have a few choices that you want users to select.

::: {.wp-block-image}
![](https://www.pythontutorial.net/wp-content/uploads/2020/11/Tkinter-Radio-Button.png){.wp-image-1280
width="300" height="251"}
:::

To create radio buttons, you use the `Radiobutton` widget. The following
shows how to create radio buttons using the `tk.Radiobutton`
constructor:
...
Each radio button has a different value. However, radio buttons in the
same group share the same variable.

The `container` is the parent widget which you place the radio buttons
on.

The `text` argument specifies the text that appears on the radio button.

The `value` argument specifies the value that the radio button will
hold.
...
The following program illustrates how to use radio buttons. It returns
the selected size once you click the **Get Selected Size** button.
...
::: {.wp-block-image}
![](https://www.pythontutorial.net/wp-content/uploads/2021/01/Tkinter-Radiobutton-Demo.gif){.wp-image-2100
width="341" height="281"}
:::

Summary
-------

-   Use `ttk.Radiobutton(text, variable)` to create a radio button; the
...
::: {.page-previous}
[Previous Tkinter
Checkbox](https://www.pythontutorial.net/tkinter/tkinter-checkbox/ "Tkinter Checkbox"){.prev-page-anchor}
:::

::: {.page-next}
[Next Tkinter
Combobox](https://www.pythontutorial.net/tkinter/tkinter-combobox/ "Tkinter Combobox"){.next-page-anchor}
:::
:::
:::
...
::: {#searchwp_live_search_results_6061477993d00 .searchwp-live-search-results aria-expanded="false" role="listbox" tabindex="0" style="left: 970px; top: 153px; width: 300px;"}
:::
